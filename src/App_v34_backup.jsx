              ...
              {isProfileMenuOpen && (
                <div className="absolute right-0 top-11 w-64 bg-geminiDarkSecondary border border-geminiBorder rounded-2xl shadow-2xl p-3 z-50 space-y-2 animate-popup">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold rounded-xl transition ${
                      theme === 'light' ? 'text-slate-700 hover:bg-slate-100' : 'text-gray-200 hover:bg-geminiHover'
                    }`}
                  >
